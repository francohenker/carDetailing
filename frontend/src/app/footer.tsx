    ...
    <footer id="contacto" className="bg-gray-900 text-white py-12">
        <div className="container">
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                <div>
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-xl font-bold">CarDetailing</span>
                    </div>
                    <p className="text-gray-400 text-sm">
                        Especialistas en detailing automotriz.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <div className="space-y-3 text-gray-400 text-sm">
                        ...
                        <div className="flex items-start">
                            ...
                            <span>+54 xxxx-xxxxxx</span>
                        </div>
                        <div className="flex items-start">
                            <svg
                                className="h-5 w-5 text-blue-400 mr-2 shrink-0"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                ...
                <div>
                    ...
                    <div className="flex space-x-4">
                        ...
                        <a href="https://www.instagram.com/diamondcardetailing21" className="text-gray-400 hover:text-white transition-colors">
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                                    fillRule="evenodd"
            ...
            <div className="border-t border-gray-800 mt-10 pt-6 text-center text-sm text-gray-400">
                <p>© 2025 CarDetailing. Todos los derechos reservados.</p>
            </div>
        </div>
    </footer>
)}